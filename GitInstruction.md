...
Для определения текущего статуса Git вводится команда `git status`. Если установка выполнена правильно, то мы увидим текущую версию Git и на какой платформе он установлен.
